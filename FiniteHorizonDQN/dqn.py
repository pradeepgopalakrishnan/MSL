# where is num_timesteps defined? What is it? Is it the same as t?
# don't use param_noise
...
class DQN(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
        ...
        # self.horizon = env.get_attr("horizon") ###
        self.horizon = 20
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            # for _ in range(total_timesteps):  # #
                ...
                if done:
                    ...
                    reset = True
                    total_ep_rew_list.append( total_ep_rew ) ###
                    ct = 0 ###
                    total_ep_rew = 0.0 ###
                else: ###
                    ct = ct + 1 ###
                ...
                if t == total_timesteps - 1: ###
                    with open('total_ep_rew_list.pkl', 'wb') as f: ###
                        pickle.dump(total_ep_rew_list, f ) ###

                threshold = ( t / total_timesteps ) * self.horizon ###
                if ct > threshold: ###
                    update_eps = 1.0 ###
                else: ###
                    update_eps = 0.0 ###
